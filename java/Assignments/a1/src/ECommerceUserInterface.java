		...
		try (Scanner scanner = new Scanner(System.in)) {
			...
			while (scanner.hasNextLine()) {
				...
				if (action == null || action.equals("")) {
					...
					// List all the current orders and shipped orders for this
					// customer id
					String customerId = "";
					...
					boolean suc = amazon.printOrderHistory(customerId);
					...
					if (scanner.hasNextLine()) {
						...
						boolean suc = amazon.cancelOrder(orderNumber);
					...
					// sort customers by name (alphabetic)
					...
					if (scanner.hasNextLine()) {
						...
						boolean suc = amazon.booksByAuthor(author);
