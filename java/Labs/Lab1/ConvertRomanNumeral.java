...
public class ConvertRomanNumeral {
	 ...
	 * 
	 * @param numeral a single Roman numeral character (i.e. char) (one of 'I' 'X'
	 *                'L' 'C' 'D' 'M')
	 * @return the integer value of numeral.
	 */
	// -----------Start below here. To do: approximate lines of code = 14
	// write a static method valueOf with the appropriate parameters and return
	// type.
	// see how this static method is called above in main() inside the println
	// statements
