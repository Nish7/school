...
public class PrintPowers {
	public static void main(String[] args) {
		...
		// Write a for loop that counts from 0 to 20 (inclusive). Declare and use a
		// variable called power as the loop variable
		// Inside the loop use the Math.pow(double a, double b) function compute 2^power
		...
		// Inside the loop, instead of calling Math.pow, use an inner loop to calculate
		// 2^power and add the result to the sum variable
		sum = 0;
