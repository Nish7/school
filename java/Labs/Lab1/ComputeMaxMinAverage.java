...
public class ComputeMaxMinAverage {
   public static void main(String[] args) {
      ...
      // Use this variable to keep track of the number of floating point numbers read
      // in from numbers string above
      int count = 0;
      // -----------Start below here. To do: approximate lines of code = 8
      // Use a while loop and read one number at a time using the scanner in (see
      // above).
      // Inside the loop, update variable sum and update variables min and max if
      // necessary
      // Don't forget to increment variable count
      // Hint: never call in.nextDouble() more than once inside a loop - call it and
