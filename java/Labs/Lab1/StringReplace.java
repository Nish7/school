 ...
 * and with the variable sentence, assigning the result to variable
 * sentenceEncoding.
 */
...
public class StringReplace {
    public static void main(String[] args) {
        ...
        // 1. Assign to townEncoding the result of applying the replace method to town
        // to replace "i" with "!" ;
        ...
        // 3. assign to sentenceEncoding the result of applying replace() on sentence to
        // replace "i" with "!".
