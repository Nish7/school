...
public class Scrabble {
	...
	public static int letterValue(char ch) {
		...
		// Use a switch statement to determine the value of a letter and return that
		// value.
		// See the comments above for Scrabble values.
		// Convert ch to an uppercase letter first before using it in the switch
		// statement
