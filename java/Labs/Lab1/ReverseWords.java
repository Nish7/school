...
public class ReverseWords {
  public static void main(String[] args) {
    ...
    while (in.hasNext()) {
      ...
      // Hint: count down rather than up in the for loop (i.e. start at the end of the
      // word)
      ...
      // -----------Start below here. To do: approximate lines of code = 4
      // 2. now repeat the reversing loop but use the reversed word from above as
      // input
      ...
      for (int i = reversedWord.length() - 1; i >= 0; i--) {
        oringalWord += reversedWord.charAt(i);
      }

      System.out.println(oringalWord);
