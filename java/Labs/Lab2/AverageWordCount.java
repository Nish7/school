...
public class AverageWordCount {
   public static void main(String[] args) {
      // array of sentences
      String sentences[] = { "Yeah, I'm gonna take my horse", "To the old town road",
      ...
      // compute the average number of words in a sentence and store in the variable
      // averageWords
   ...
   // Calculate the number of words in the input String sentence. Return the number
   // of words.
   static int wordCount(String sentence) {
      // -----------Start below here. To do: approximate lines of code = 7
      // There are several ways to solve this. One basic way is to use a Scanner, then
      // in a while loop read the words one by
      // one and increase the word count. Another way is to use the StringTokenizer
      // class.
