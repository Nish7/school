/**
 * Given two sets of strings (stored in two arrays), determine if they are the
 * same set
...
public class SetChecker {
   ...
   public static void main(String[] args) {
      String[] setA = { "January", "February", "March", "April", "May", "June", "July", "August", "September",
            "October", "November", "December" };
      String[] setB = { "January", "March", "April", "May", "June", "July", "August", "September", "October",
            "November", "December" };
   ...
   public static boolean isIn(String elem, String[] set) {
      ...
      // go through the parameter array named set and check if an element (string) in
      // the array
      // is equal to the given string parameter elem. If elem is in the set, return
      // true
      // After checking through the entire set, if the method hasn't already returned,
      // then return false
