...
class BankAccount {
	...
	public void deposit(double amount) {
		...
		if (amount < 0) {
			throw new IllegalArgumentException("Deposit amoutn is negative!");
		}
	...
	public void withdraw(double amount) {
		// -----------Start below here. To do: approximate lines of code = 1
		// 4. Throw an IllegalArgumentException if the amount is too much or if amount
		// is negative
		// set the message in the exception to: "withdrawal amount is negative or
