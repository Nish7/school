...
public class LoginForm {
   ...
   public void input(String text) {
      ...
      // if this is the first input (Hint: use the firstInput variable) , must be the
      // username so set currentUsername = text
      // and set firstInput to false. Otherwise, must be the password so set
      // currentPassword
