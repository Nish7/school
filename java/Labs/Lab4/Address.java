...
public class Address {
	...
	/**
	 * Compares two addresses by first comparing province, then city, street,
	 * streetNumber, apartment
	 * This method must have the given signature as it is inherited from superclass
	 * Object
	 * 
	...
	public boolean equals(Object other) {
		...
		// compare the province, city, street, streetNumber, and apartment of this
		// address and the other address otherA. If all are equal, return true
		// else return false. We will study the inherited equals method in class this
		// week

		if (!this.province.equals(province)) {
			return false;
		} else if (!this.city.equals(otherA.city)) {
			return false;
		} else if (!this.street.equals(otherA.street)) {
			return false;
		} else if (!this.streetNumber.equals(otherA.streetNumber)) {
			return false;
		} else if (!this.apartment.equals(otherA.apartment)) {
			return false;
		}
