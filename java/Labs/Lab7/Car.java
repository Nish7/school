...
public class Car implements Comparable<Car> {
   ...
   // The method should compare two cars based on fuel efficiency (higher fuel
   // efficiency is better)

   public int compareTo(Car c) {
      if (this.fuelEfficiency > c.fuelEfficiency) {
         return 1;
      } else if (this.fuelEfficiency < c.fuelEfficiency) {
         return -1;
      }
      return 0;
   }
