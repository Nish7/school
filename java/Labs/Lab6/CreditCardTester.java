...
public class CreditCardTester {
    public static void main(String[] args) {
        ...
        card = new CreditCard();
        // NOTE: this will automatically execute the toString() method of class
        // CreditCard
...
class CreditCard extends IDCard {
    ...
    /**
     * A default constructor method to initialize id to "000000" and expiration year
     * to 0
     */
    public CreditCard() {
        super();
    ...
    /**
     * A constructor method that initializes name, id and expiryYear with given
     * values
     * 
     * @param name1      the given name
    ...
    public CreditCard(String name1, String id1, int expiryYear) {
        ...
        // -----------Start below here. To do: approximate lines of code = 3
        // 3-5. fill in this constructor and use the super call to initialize the
        // inherited variables - see class IDCard
        super(name1);
        this.id = id1;
    ...
    public String toString() {
        // -----------Start below here. To do: approximate lines of code = 1
        // -----------Start below here. To do: approximate lines of code = 1
        // 6. something like: "CreditCard[name = Joe Turner][id = 1342343, expires
        // 1999]" and use the super call
        return super.toString() + "[id = " + this.id + ", expires "
                + this.expirationYear + "]";
