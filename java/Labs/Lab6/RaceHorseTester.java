...
public class RaceHorseTester {
    public static void main(String[] args) {
        ...
        System.out.println(horse);
        System.out.println(
                "RaceHorse[name = Blaze, year = 2009][trainer = Charles Chase, wins = 1, places = 3, losses = 2] WAS EXPECTED");
    }
}
...
class Horse {
    ...
    /**
     * A default constructor method to initialize name and year with default name
     * and year
     */
    public Horse() {
        name = "Horse";
    ...
    /**
     * A default constructor method that initializes name and year with given name
     * and year of birth
     * 
...
class RaceHorse extends Horse {
    ...
    /**
     * A default constructor method that initializes inherited variables as well as
     * added variables trainer, wins, places, losses
    ...
    /**
     * A constructor method to initialize inherited name variable and variables year
     * and trainer with given parameter variables
    ...
    public RaceHorse(String name1, int year, String trainer) {
        ...
        // -----------Start below here. To do: approximate lines of code = 2
        // 3. super call to initialize inherited name (HINT: use super() call with
    ...
    public String toString() {
        // -----------Start below here. To do: approximate lines of code = 2
        // -----------Start below here. To do: approximate lines of code = 2
        // 5-6. something like: "RaceHorse[name = Lucky Star, year = 2011][trainer =
        // Billy Wonder, wins = 1, places = 2, losses = 10]" and use super call

        return super.toString() + "[trainer = " + this.trainer + ", wins = " + this.wins + ", places = " + this.places
                + ", losses = " + this.losses + "]";
        // Billy Wonder, wins = 1, places = 2, losses = 10]"
