 ...
 * 
 * Note: interestRate is "protected" here so that it is directly accessible to
 * the
 * subclass.
 */
...
class SavingsAccountMinimum extends SavingsAccount {
    ...
    // -----------Start below here. To do: approximate lines of code = 1
    // 1. add a new instance variable called minimumBalance to store the minimum
    // balance
    ...
    /**
     * A constructor method to initialize the inherited interestRate variable and
    ...
    public void addInterest() {
        ...
        // -----------Start below here. To do: approximate lines of code = 3
        // 2. double interest = ...
        // note: interestRate is a percent and is "protected" in supeclass
        // SavingsAccount
        // note: the interest depends on the minimum balance not on the inherited
        // balance variable
        // see the addInterest() method in the superclass
        double interest = this.minimumBalance * interestRate / 100;

        // 3. somehow add the computed interest to the balance (use an inherited
        // method!),
        deposit(interest);
        ...
        this.minimumBalance = (int) getBalance();
